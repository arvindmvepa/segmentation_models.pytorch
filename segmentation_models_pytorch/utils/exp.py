...
def test_net(model_path, encoder='se_resnext50_32x4d', encoder_weights='imagenet', height=608, width=608,
...
def val_net(model_path, encoder='se_resnext50_32x4d', encoder_weights='imagenet', height=608, width=608,
...
def train_net(data_dir='/home/ubuntu/work/vessel_seg/data/DRIVE/train/images',
              ...
              activation='sigmoid', height=608, width=608, loss=('bce_lts', {}), pos_scale= None,
    ...
    loss = losses[loss[0]](pos_weight=torch.FloatTensor([get_pos_wt(masks_fps=train_dataset.masks_fps,
                                                                    omasks_fps=train_dataset.omasks_fps,
                                                                    c=pos_scale)]),
